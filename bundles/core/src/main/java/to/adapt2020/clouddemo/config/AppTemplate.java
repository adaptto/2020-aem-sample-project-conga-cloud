package to.adapt2020.clouddemo.config;
...
public enum AppTemplate implements TemplatePathInfo {
   ...
   * Structure element
   */
  ADMIN_STRUCTURE_ELEMENT("/apps/adaptto-cloud-demo/core/templates/admin/structureElement"),

  /**
   * Redirect
   */
  ADMIN_REDIRECT("/apps/adaptto-cloud-demo/core/templates/admin/redirect"),

  /**
   * Content page
   */
  CONTENTPAGE("/conf/adaptto-cloud-demo/settings/wcm/templates/contentpage"),

  /**
   * Home page
   */
  HOMEPAGE("/conf/adaptto-cloud-demo/settings/wcm/templates/homepage");
