package to.adapt2020.clouddemo.testcontext;
...
import to.adapt2020.clouddemo.config.AppTemplate;
import to.adapt2020.clouddemo.config.impl.LinkHandlerConfigImpl;
import to.adapt2020.clouddemo.config.impl.MediaFormatProviderImpl;
import to.adapt2020.clouddemo.config.impl.MediaHandlerConfigImpl;
